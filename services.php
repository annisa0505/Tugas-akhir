...
<html lang="en">
  ...
  <body class="section-light">
		  ...
		  <div class="container">
			...
			<div class="collapse navbar-collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="active"><a href="services.html">Info</a></li>
	...
	<div class="section-light top-inner"></div>
	...
	<section class="section-main">
		<div class="container">
			<div class="col-md-12">
				<h2 class="page-header heading-secondary-a">Info Pemesanan</h2>
					<ul style="list-style: square;">
					  <li> Terdapat 2 pilihan dalam mentukan ukuran yaitu ukuran umum ( ex :  S, M, L, etc), dan ukuran detail (ex :Lingkar Leher (L L), Lingkar Badan (L B), Lebar Punggung / Pundak (L P), etc).</li><br>
